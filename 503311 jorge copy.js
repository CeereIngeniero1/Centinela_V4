...
const CodigoPin = "V2";
const ARCHIVO_AREAS = "Prueba503311";
...
async function Login(page) {
  ...
  try {
    console.log(Agente == 1 ? "Login modo AGENTE:" : "Login modo EMPRESA:", user);
    console.log(pass);
...
async function esperarContinuarHumano(page, etiqueta = "") {
  ...
  console.log(
    `⏳ ${prefijo}Modo continuarManual: haga clic en Continuar. El bot espera...`
      .yellow
  );
